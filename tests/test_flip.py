...
@pytest.mark.parametrize(
    "flip_bed_range, bed_error",
    [
        (BedRange("scaffold_18", 1, 100000), EmptyRangeError),
        (BedRange("scaffold_18", 1930402, 2637458), BadRangeError),
    ],
)
def test_bad_flip(sample_agp_rows, flip_bed_range, bed_error):
    with pytest.raises(bed_error):
